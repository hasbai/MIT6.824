...
//
func (EarlyExit) Map(filename string, contents string) []models.KeyValue {
	var kva []models.KeyValue
	kva = append(kva, models.KeyValue{Key: filename, Value: "1"})
	return kva
}
...
// any map task.
//
func (EarlyExit) Reduce(key string, values []string) string {
